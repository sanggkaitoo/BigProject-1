"""
Django settings for AnKhangHotel project.
...
SECRET_KEY = 'django-insecure-5z7f*^+-eyi47kfr@o812+8w))_duks7cao@ytl-+7p&1%p6kh'
...
ROOT_URLCONF = 'AnKhangHotel.urls'
...
WSGI_APPLICATION = 'AnKhangHotel.wsgi.application'
